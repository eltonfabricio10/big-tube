...
class SettingsDialog(Adw.PreferencesDialog):
    ...
    def setup_advanced_page(self):
        ...
        concurrent_downloads_row.set_value(self.settings.get('concurrent_downloads', 2))
    ...
    def on_apply_clicked(self, button):
        ...
        self.settings['concurrent_downloads'] = int(self.concurrent_downloads_row.get_value())
